...
export const CHANGE_IMAGE_COMPLETED = "project/users/changeImageCompleted";
export const CHANGE_ROLE_COMPLETED = "project/users/changeRoleCompleted";
export const CHANGE_LANGUAGE_COMPLETED = "project/users/changeLanguageCompleted";
